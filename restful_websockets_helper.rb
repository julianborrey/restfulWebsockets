# restful_websockets_helper.rb
# by Julian Borrey
# Last Updated: 28/01/2014
# Released under MIT license.
# 
# Helper to include in your WebsocketRails::Basecontroller object.
# These functions allow you to load partials with inputs and then 
# construct a JSON object of new refreshed HTML to be updated 
# by restfulWebsocket.js on the client side.

module RestfulWebsocketsHelper
   @partials = nil;
